...
$sql = "SELECT pid, project.eid, pname, duedate, subdate, remark, points, firstName, lastName, base, bonus, total FROM `project` , `rank` ,`employee`, `salary`  WHERE project.eid = $id AND pid = $pid";
