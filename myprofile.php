...
$result = mysqli_query($conn, $sql);
  ...
  $staffid = $res['firstName']; 
  $firstname = $res['staffid'];
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="input-group">
                          <p>Status</p>
                            <input class="input--style-1" type="text" name="super_status" value="<?php echo $super_status;?>" readonly>
                        </div>

                        

                        <input type="hidden" name="id" id="textField" value="<?php echo $staffid;?>" required="required"><br><br>
                        <div class="p-t-20">
